...
@StreamBot.on_message((filters.command("start") | filters.regex('𝘀𝘁𝗮𝗿𝘁✅')) & filters.private )
async def start(b, m):
...
@StreamBot.on_message((filters.command("help") | filters.regex('𝗛𝗲𝗹𝗽📚')) & filters.private )
